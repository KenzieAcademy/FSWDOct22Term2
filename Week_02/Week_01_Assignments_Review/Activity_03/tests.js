...
console.group("Unit Tests - isTheSameObjectShallow");
{
  kenzieAssert({
    ...
    failureMessage:
      "isTheSameObjectShallow is true if the object is the same, and if the object has the same properties and values but is at a different memory location",
  });
  kenzieAssert({
    ...
    testFunction: "isTheSameObjectShallow",
    failureMessage:
      "isTheSameObjectShallow is true if both objects have the same properties and values.",
  });
  kenzieAssert({
